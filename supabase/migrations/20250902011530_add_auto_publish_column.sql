...
-- IMPORTANT: Set auto_publish to false for existing scheduled events to prevent unintended auto-publishing
-- This ensures only new events or explicitly opted-in events will auto-publish
