-- Migration: Add race_color to get_profile_with_roles RPC function
...
COMMENT ON FUNCTION public.get_profile_with_roles(
    uuid
) IS 'Retrieves a user''s profile along with their role assignments (including isAdmin flag and race_color).';
