export const eventOpeningMailCopy = {
  ...
  important: {
    ...
    notes: {
      ...
      notSelected:
        "Candidatar-se pelo formulário <strong>não significa</strong> que você será selecionade para participar do evento;",
      socialTickets:
  ...
  footer: {
    reason: "Você recebeu este e-mail pois assina a newsletter da",
    brand: "Positiv",
