  ...
  describe('EventAnnouncement', () => {
    it('should render event announcement template with required props', async () => {
      const props = {
        ...
        content: '<h1>Summer Party</h1><p>Join us for an amazing summer event!</p>',
  ...
  describe('GeneralNews', () => {
    it('should render general news template with required props', async () => {
      const props = {
        ...
        content: '<h1>News</h1><p>Here are the latest updates from our community.</p>',
        unsubscribeUrl: 'https://positiv.com/unsubscribe?token=def456'
      }
    ...
    it('should include unsubscribe link in footer', async () => {
      const props = {
        ...
        unsubscribeUrl: 'https://positiv.com/unsubscribe?token=ghi012'
      }
