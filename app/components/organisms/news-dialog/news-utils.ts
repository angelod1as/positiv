...
export const DEFAULT_NEWS_ITEMS: NewsItem[] = [
  {
    ...
    content: 'As planilhas de participantes agora incluem numeração automática (coluna "Nº") e uma coluna "Staff" que identifica visualmente membros da equipe. Facilita conferências e organização!',
    isAdmin: true,
  ...
  },
  {
    ...
    content: 'Melhorias na formatação de contatos: agora pessoas cis também aparecem com abreviações (MC/HC) quando relevante, e "Pessoa agênera" usa AG. Formatação mais consistente!',
    isAdmin: true,
  ...
  },
  {
    ...
    content: 'O banner de avisos importantes agora aparece apenas na homepage e página de login, reduzindo distrações em outras páginas do site.',
    isAdmin: true,
  ...
  },
  {
    ...
    content: 'Ajuste no cálculo automático de datas: o início do período de grupos mudou de 7 para 4 dias antes do evento, alinhado com o processo atual.',
    isAdmin: true,
