...
import type { Route } from "./+types/view-event-participant-ag"
...
const ViewEventParticipantAG = ({ loaderData }: Route.ComponentProps) => {
...
export default ViewEventParticipantAG
